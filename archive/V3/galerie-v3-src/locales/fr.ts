const fr = {
  ...
  nav: {
    ...
    links: [
      ...
      { label: "Expositions", href: "/collections#expositions" },
  ...
  collections: {
    ...
    explore: "Explorer",
    items: [
      { title: "Maîtres Contemporains", subtitle: "Peinture actuelle",      count: "47 œuvres" },
      { title: "Paysage Québécois",     subtitle: "Territoires et lumières", count: "83 œuvres" },
      { title: "Abstraction Lyrique",   subtitle: "Formes & couleurs",       count: "31 œuvres" },
      { title: "Natures Mortes",        subtitle: "Objets & compositions",   count: "24 œuvres" },
    ],
  },
  ...
  showcase: {
    ...
    artworks: [
      { ref: "G-0963", title: "Tirlata Sturt Pers",   artist: "Jules Michel",    year: "1977", medium: "Techniques mixtes — Huile sur toile", dimensions: '46" × 34"', price: "10 000" },
      { ref: "G-0228", title: "Urbanisation",          artist: "Stefan Hagiu",    year: "2019", medium: "Huile sur toile",                     dimensions: '96" × 48"', price: "4 995"  },
      { ref: "G-0967", title: "Hiver Pastoral",        artist: "Rajka Kupesic",   year: "2024", medium: "Huile sur toile",                     dimensions: '16½" × 12½"', price: "2 995" },
      { ref: "G-1030", title: "Portrait de Femme",     artist: "Elena Carla",     year: "2023", medium: "Huile sur toile",                     dimensions: '31" × 46"', price: "2 995"  },
      { ref: "G-0192", title: "Le Fleuve de la Vie",   artist: "Liguori Vachon",  year: "2020", medium: "Acrylique sur toile — Triptyque",     dimensions: '72" × 48"', price: "2 995"  },
    ],
  },
  ...
  collectionsPage: {
    ...
    hero_sub: "Plus de 950 œuvres originales d'artistes peintres québécois, soigneusement sélectionnées.",
    filter_all: "Tout",
    ...
    artworks: [
      { ref: "G-0963", title: "Tirlata Sturt Pers",       artist: "Jules Michel",   year: "1977", medium: "Techniques mixtes",         dimensions: '46" × 34"',   price: "10 000", category: "contemporain", image: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=800&q=85&fit=crop", featured: true },
      { ref: "G-0928", title: "Marché Persan",             artist: "Jules Michel",   year: "2018", medium: "Huile sur toile",            dimensions: '36" × 24"',   price: "8 000",  category: "contemporain", image: "https://images.unsplash.com/photo-1531913764164-f85c52e6e654?w=800&q=85&fit=crop", featured: true },
      { ref: "G-0228", title: "Urbanisation",              artist: "Stefan Hagiu",   year: "2019", medium: "Huile sur toile",            dimensions: '96" × 48"',   price: "4 995",  category: "abstraction",  image: "https://images.unsplash.com/photo-1518998053901-5348d3961a04?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0967", title: "Hiver Pastoral",            artist: "Rajka Kupesic",  year: "2024", medium: "Huile sur toile",            dimensions: '16½" × 12½"', price: "2 995",  category: "paysage",      image: "https://images.unsplash.com/photo-1545987796-200677ee1011?w=800&q=85&fit=crop", featured: false },
      { ref: "G-1030", title: "Portrait de Femme",         artist: "Elena Carla",    year: "2023", medium: "Huile sur toile",            dimensions: '31" × 46"',   price: "2 995",  category: "portrait",     image: "https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0192", title: "Le Fleuve de la Vie",       artist: "Liguori Vachon", year: "2020", medium: "Acrylique, triptyque",       dimensions: '72" × 48"',   price: "2 995",  category: "abstraction",  image: "https://images.unsplash.com/photo-1509839862426-cfed742f4e23?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0220", title: "L'Inévitable",              artist: "Stefan Hagiu",   year: "2017", medium: "Huile sur toile",            dimensions: '72" × 48"',   price: "2 995",  category: "abstraction",  image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0845", title: "Solitude Boréale",          artist: "Rajka Kupesic",  year: "2022", medium: "Huile sur toile",            dimensions: '24" × 36"',   price: "1 800",  category: "paysage",      image: "https://images.unsplash.com/photo-1566438480900-0609be27a4be?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0912", title: "Composition No. 7",         artist: "Elena Carla",    year: "2021", medium: "Acrylique sur toile",        dimensions: '40" × 40"',   price: "1 600",  category: "abstraction",  image: "https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0756", title: "La Lumière de Décembre",    artist: "Liguori Vachon", year: "2019", medium: "Huile sur toile",            dimensions: '48" × 36"',   price: "3 200",  category: "paysage",      image: "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0634", title: "Mémoire Collective",        artist: "Jules Michel",   year: "2015", medium: "Techniques mixtes",         dimensions: '60" × 48"',   price: "5 500",  category: "contemporain", image: "https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?w=800&q=85&fit=crop", featured: false },
      { ref: "G-0801", title: "Regard Intérieur",          artist: "Elena Carla",    year: "2022", medium: "Huile sur toile",            dimensions: '20" × 24"',   price: "1 200",  category: "portrait",     image: "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?w=800&q=85&fit=crop", featured: false },
    ],
  },
  ...
  aboutPage: {
    ...
    team: [
      { name: "Claude Beaumont",   role: "Fondateur & Directeur",      bio: "Fondateur de la galerie en 1994, Claude consacre sa vie à la promotion de l'art québécois. Il est reconnu comme l'un des curateurs les plus influents de la province.",       image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80&fit=crop&crop=face" },
      { name: "Marie-Ève Tremblay", role: "Directrice artistique",      bio: "Après quinze ans dans les plus grandes galeries de Montréal et Paris, Marie-Ève a rejoint la galerie pour enrichir notre programmation d'expositions temporaires.",           image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=400&q=80&fit=crop&crop=face" },
      { name: "Philippe Garneau",   role: "Conseiller aux collectionneurs", bio: "Fort de vingt ans d'expérience dans le marché de l'art, Philippe guide nos collectionneurs avec discernement, qu'il s'agisse d'une première acquisition ou d'une collection établie.", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80&fit=crop&crop=face" },
    ],

    // Press
    press_eyebrow: "Ils parlent de nous",
    press_quotes: [
      { quote: "La Galerie Artistes Peintres s'impose comme la référence incontournable pour quiconque souhaite explorer la richesse de la peinture québécoise contemporaine.", source: "Le Devoir", year: "2023" },
      { quote: "Une expérience de collection rare, où chaque acquisition devient une rencontre entre l'œuvre et son nouveau foyer.", source: "Le Soleil", year: "2022" },
      { quote: "Claude Beaumont a réussi le prodige de rendre l'art de grande qualité accessible, sans jamais en diminuer la valeur.", source: "La Presse", year: "2024" },
    ],

    // Contact
    contact_eyebrow: "Nous écrire",
    contact_heading: "Entamons la conversation",
    contact_sub: "Que vous souhaitiez acquérir une œuvre, planifier une visite privée ou simplement en savoir plus sur notre collection, notre équipe est à votre disposition.",
    contact_info: [
    ...
    form_subjects: ["Acquisition d'une œuvre", "Visite privée", "Renseignements généraux", "Partenariat ou presse", "Autre"],
