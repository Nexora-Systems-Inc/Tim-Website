...
TITLE_CORRECTIONS = {
    ...
    "C-0006": {"title": "Le Solitaire", "medium": "Acrylique Fini Époxy"},
    "C-0007": {"title": "TOURBILLON"},
    "C-0011": {"title": "SPLASH DE COULEURS"},
    "C-0015": {"title": "TENDRESSE"},
    "C-0018": {"title": "GUIDE MOI"},
    "C-0019": {"title": "SENTIER DE PAIX"},
    "C-0022": {"title": "MES FLEURS IMAGINAIRES"},
