...
export default function DarkPageHero({ eyebrow, heading, sub }: DarkPageHeroProps) {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden" style={{ height: "72vh", minHeight: "520px", background: "var(--charcoal)" }}>
      ...
      <motion.div className="absolute inset-0" style={{ y, scale: 1.1 }}>
        <img
          src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1800&q=85&fit=crop"
          alt=""
          aria-hidden
